...
export function HomeContent({ stats }: { stats: HomeStats }) {
  ...
  return (
    <div className="flex flex-1 flex-col">
      {/* Header */}
      <div className="flex items-center justify-between gap-2.5 px-[18px] pb-2.5 pt-2">
        <div className="flex items-center gap-2.5">
          <span
            aria-hidden
      ...
      <div className="px-[14px] pb-4 pt-3">
        <Link
          href="/support"
          className="flex w-full items-center gap-3 rounded-[16px] border px-4 py-3 text-left"
        ...
        >
          ...
          <span className="flex-1 text-[13px] font-semibold" style={{ color: palette.greenDeep }}>
            Маєте питання? Написати в підтримку
          </span>
          <ArrowRight className="size-[16px] opacity-40" style={{ color: palette.greenDeep }} />
        </Link>
      </div>
    </div>
  );
